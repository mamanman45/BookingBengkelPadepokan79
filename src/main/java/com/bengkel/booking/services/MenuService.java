	...
	public static void mainMenu() {
		...
		do {
			...
			case 2:
				...
				BengkelService.bookingBengkel(input, Validation.getCustomerById(customerIdGeneral, listAllCustomers).getVehicles(), listAllItemService, Validation.getCustomerById(customerIdGeneral, listAllCustomers), listAllBookingOrders);
				break;
			case 3:
